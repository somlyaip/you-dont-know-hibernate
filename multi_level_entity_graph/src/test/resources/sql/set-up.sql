...
ALTER TABLE development_attributes
    ADD CONSTRAINT fk_development_attributes_branch_id FOREIGN KEY (branch_id) REFERENCES branch (id);
...
VALUES (1, 'feature/1-awesome-form');

INSERT INTO merge_request(id)
VALUES (1);

INSERT INTO development_attributes(id, branch_id, merge_request_id)
VALUES (1, 1, 1);
